...
<acme:list-column code="anonymous.investor-record.list.label.statement" path="statement" width="20%"/>
<acme:list-column code="anonymous.investor-record.list.label.star" path="star" width="30%"/>
